...
import 'package:mercadoaberto/components/botao.dart';
...
import 'package:mercadoaberto/components/endr.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
     ...
     backgroundColor: Color(0xfff5d415),
      ...
      bottom: PreferredSize(
        ...
        child: ListTile(leading: IconButton(icon:Icon(Icons.pin_drop_outlined), color: Colors.black, onPressed: () {  }),
        //  endr(),
    ...
    Assinatura(
     ...
     Row(
       children: [
         botao(icone: Icons.search, text: 'Pesquisa',),
         SizedBox(width: 10,),
         botao(icone: Icons.add_card_outlined, text:'Adicionar cartão'),
         SizedBox(width: 10,),
         botao(icone: Icons.local_shipping, text:'Frete'),
         SizedBox(width: 10,),
         botao(icone: Icons.add_shopping_cart_sharp, text:'Compras'),
         SizedBox(width: 10,),
       ],
     )
        ]
